...
<div class="box_container">
  ...
  <!--          	<div class="item_lienhe"><p><?=_hovaten?>-->
  <!--          	:<span>*</span>-->
  <!--          	</p><input name="ten_lienhe" type="text" id="ten_lienhe" /></div>-->
                
  <!--              <div class="item_lienhe"><p><?=_diachi?>-->
  <!--              :<span>*</span>-->
  <!--              </p><input name="diachi_lienhe" type="text" id="diachi_lienhe" /></div>-->
                
  <!--              <div class="item_lienhe"><p><?=_dienthoai?>:<span>*</span></p><input name="dienthoai_lienhe" type="text" id="dienthoai_lienhe" /></div>-->
                
  <!--              <div class="item_lienhe"><p>Email-->
  <!--              :<span>*</span>-->
  <!--              </p><input name="email_lienhe" type="text" id="email_lienhe" /></div>-->
                
  <!--              <div class="item_lienhe"><p><?=_chude?>-->
  <!--              :<span>*</span>-->
  <!--              </p><input name="tieude_lienhe" type="text" id="tieude_lienhe" /></div>-->
